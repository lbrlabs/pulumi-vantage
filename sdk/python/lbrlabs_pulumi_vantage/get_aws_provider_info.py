...
__all__ = [
    'GetAwsProviderInfoResult',
    'AwaitableGetAwsProviderInfoResult',
    'get_aws_provider_info',
]

@pulumi.output_type
class GetAwsProviderInfoResult:
    """
...
class AwaitableGetAwsProviderInfoResult(GetAwsProviderInfoResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAwsProviderInfoResult(
...
def get_aws_provider_info(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAwsProviderInfoResult:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('vantage:index/getAwsProviderInfo:getAwsProviderInfo', __args__, opts=opts, typ=GetAwsProviderInfoResult).value

    return AwaitableGetAwsProviderInfoResult(
