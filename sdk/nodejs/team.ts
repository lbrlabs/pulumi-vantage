...
export class Team extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vantage:index/team:Team';
     ...
     * User emails.
     */
    public readonly userEmails!: pulumi.Output<string[]>;
    /**
     * User tokens.
     */
     ...
     */
    public readonly workspaceTokens!: pulumi.Output<string[]>;
    ...
    constructor(name: string, argsOrState?: TeamArgs | TeamState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["workspaceTokens"] = state ? state.workspaceTokens : undefined;
        } else {
            ...
            resourceInputs["workspaceTokens"] = args ? args.workspaceTokens : undefined;
...
export interface TeamState {
     ...
     * Workspace tokens to add the team to.
     */
    workspaceTokens?: pulumi.Input<pulumi.Input<string>[]>;
}
