...
export class Folder extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vantage:index/folder:Folder';
     ...
     */
    public readonly parentFolderToken!: pulumi.Output<string>;
    /**
     * Title of the folder
     */
    ...
    constructor(name: string, argsOrState?: FolderArgs | FolderState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["parentFolderToken"] = state ? state.parentFolderToken : undefined;
            ...
            resourceInputs["parentFolderToken"] = args ? args.parentFolderToken : undefined;
...
export interface FolderState {
     ...
     * Token of the folder's parent folder
     */
    parentFolderToken?: pulumi.Input<string>;
    /**
     * Title of the folder
     */
