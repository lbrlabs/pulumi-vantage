module github.com/lbrlabs/pulumi-vantage/provider
...
require (
	...
	github.com/vantage-sh/terraform-provider-vantage/shim v0.0.0
)
...
require (
	...
	github.com/vantage-sh/terraform-provider-vantage v0.1.9 // indirect
